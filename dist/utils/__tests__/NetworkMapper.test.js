...
describe('NetworkMapper', () => {
    ...
    describe('createNetwork', () => {
        ...
        it('should handle network creation errors', async () => {
            const dbError = new Error('Duplicate network');
            const mockSingle = jest.fn().mockReturnValue({
                data: null,
                error: dbError
            });
    ...
    describe('createNetworkRelationship', () => {
        ...
        it('should handle relationship creation errors', async () => {
            const dbError = new Error('Invalid relationship');
            const mockInsert = jest.fn().mockReturnValue({
                data: null,
                error: dbError
            });
    ...
    describe('validateNetworkRelationships', () => {
        ...
        it('should handle validation query errors', async () => {
            const dbError = new Error('Validation query failed');
            const mockSelect = jest.fn().mockReturnValue({
                data: null,
                error: dbError
            });
    ...
    describe('generateMappingReport', () => {
        ...
        it('should handle report generation errors', async () => {
            const dbError = new Error('Report generation failed');
            const mockSelect = jest.fn().mockReturnValue({
                data: null,
                error: dbError
            });
...
//# sourceMappingURL=NetworkMapper.test.js.map