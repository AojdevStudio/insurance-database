...
import type { ICarrier, ICarrierListResponse, ICarrierListResponseJSON } from '../../types/carrier.js';

// Mock CarrierService
jest.mock('../../services/carrier.service.js');

const mockCarrierService = CarrierService as jest.Mocked<typeof CarrierService>;
...
describe('Carrier Routes', () => {
  ...
  describe('GET /api/carriers', () => {
    it('should return a list of carriers', async () => {
      const mockCarriers: ICarrierListResponse = {
        carriers: [
          {
            id: 1,
            name: 'Test Carrier',
      ...
      const expectedResponse: ICarrierListResponseJSON = {
        ...mockCarriers,
      ...
      expect(response.body as ICarrierListResponseJSON).toEqual(expectedResponse);
    });
  ...
  describe('GET /api/carriers/search', () => {
    it('should search carriers by query', async () => {
      const mockSearchResults: ICarrierListResponse = {
        carriers: [
          {
            id: 1,
            name: 'Test Carrier',
    ...
    it('should handle empty search results', async () => {
      const mockEmptyResults: ICarrierListResponse = {
        carriers: [],
        total: 0,
        page: 1,
        limit: 10,
      ...
      expect(response.body as ICarrierListResponseJSON).toEqual(mockEmptyResults);
    });
  ...
  describe('GET /api/carriers/:id', () => {
    it('should return a carrier by ID', async () => {
      ...
      expect(response.body as typeof expectedResponse).toEqual(expectedResponse);
    });
