...
import type { IProcedure, IProcedureWithRequirements } from '../../types/procedure.js';

// Mock ProcedureService
jest.mock('../../services/procedure.service.js');

const mockProcedureService = ProcedureService as jest.Mocked<typeof ProcedureService>;
...
describe('Procedure Routes', () => {
  ...
  describe('GET /api/procedures/:code', () => {
    it('should return a procedure by code', async () => {
      const mockProcedure: IProcedure = {
        id: 1,
        code: 'TEST1',
        description: 'A test medical procedure',
        category: 'Test Category',
