...
import type { IGuidelineSearchResult, IGuideline } from '../../types/guidelines.js';
...
describe('GuidelineService', () => {
  ...
  describe('searchGuidelines', () => {
    const mockGuidelines: IGuideline[] = [
      {
        id: 1,
        carrier_id: 1,
  ...
  describe('semanticSearch', () => {
    ...
    it('should handle embedding generation errors', async () => {
      (OpenAIService.createEmbedding as jest.Mock).mockRejectedValue(
